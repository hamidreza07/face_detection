...
img_path = ['brigh_cont','brigh_cont - rotate','brigh_gray_rotate','gray_scale','gray_scale - rotation','main_rotation']
output = args.save_path
for file in img_path:
    for img in os.listdir(file):
        image = Image.open(file+"/"+img).convert("RGB")
